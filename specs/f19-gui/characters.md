...
- 原型引用：design/GUI/characters/characters.html + characters-<state>.png（detail/main/rank-protagonist）
...
│ [项目选择器 青云志 ▾]  面包屑：设定库 · 青云志 / 角色        │
├──────────────────────────────────────────────────────────────┤
│ 分类 tab：角色│世界观│大纲│时间线│伏笔│知识图谱              │
├──────────────────────────────────────────────────────────────┤
│ 工具栏（右缘）：[去创建]  [AI 提取]                          │
│ ┌──────────────────────────────────────────────────────────┐ │
│ │ 等级选项卡：全部·总览 主角 重要配角 配角 场景角色 一次性 │ │
│ │ 分组卡片（组头「组名 · n人」+ 成员行，未分组殿后）：     │ │
│ │   青云宗 · 4人                                           │ │
│ │     苏云舟 [主角] [青云宗][剑修]       悬停：[编辑][删除]│ │
│ │     林晚照 [重要配角] [青云宗][医修]                     │ │
│ │   剑冢守卫 · 2人 / 未分组 · 1人（同构）                  │ │
│ │ 行名点击 → 角色详情面板（弹层：分组多选 + 关系 CRUD）    │ │
│ └──────────────────────────────────────────────────────────┘ │
│ 弹层：创建/编辑对话框 520px（名称+等级双必填）/分组管理 480px│
└──────────────────────────────────────────────────────────────┘
```
- 参考锚点（真实实现）：
