...
>
> **快速导航**（2026-08-08 #201）：
> [1. 概述](L12) · [2. 数据模型](L38) · [3. API 契约](L113) · [4. CLI 命令签名](L210)
> [5. 核心流程](L256) · [6. 格式校验与自动重试](L299) · [7. 边界情况与错误处理](L322) · [8. 文件结构](L348)
> [9. 测试策略](L411) · [10. 不在范围内](L476) · [11. 依赖关系](L493) · [12. 关键架构决策记录](L510)
---
