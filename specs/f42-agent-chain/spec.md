...
> **2026-08-16 承接说明（v1.4）**：#270 已由独立 spec `specs/f46-dag/spec.md` 承接（0.9.0，作为其唯一真相来源）。本模块的演进约束已全部落地，不再承担「预留」职责：
