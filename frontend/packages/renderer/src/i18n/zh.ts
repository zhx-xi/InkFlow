...
export const zh = {
  // 布局/导航
  'app.brand': 'InkFlow',
  'nav.writing': '写作', 'nav.projects': '项目', 'nav.library': '设定库',
  ...
  'lib.create.goals': '目标',
  'lib.create.category': '类别', 'lib.create.categoryRequired': '非根条目必须填写类别',
  ...
  'lib.map.renameSave': '保存', 'lib.map.unmappedSection': '未挂图条目（{n}）',
  ...
  'lib.addOverall': '＋整本',
  'lib.addPoint': '＋情节点',
  // #649：大纲子项写操作（情节节点 / 故事弧 CRUD + AI 生成）
  'lib.point.createTitle': '新建情节点',
  'lib.point.editTitle': '编辑情节点',
  'lib.point.name': '情节点名称',
  'lib.point.type': '类型',
  'lib.point.desc': '描述',
  'lib.point.arc': '故事弧',
  'lib.point.arcNone': '（不挂弧线）',
  'lib.point.save': '保存',
  'lib.point.cancel': '取消',
  'lib.point.deleteTitle': '删除情节点',
  'lib.point.deleteConfirm': '确认删除情节节点「{name}」？',
  'lib.arcs.title': '故事弧',
  'lib.arcs.create': '＋新建故事弧',
  'lib.arcs.createTitle': '新建故事弧',
  'lib.arcs.editTitle': '编辑故事弧',
  'lib.arcs.name': '弧线名称',
  'lib.arcs.desc': '弧线描述',
  'lib.arcs.empty': '暂无故事弧',
  'lib.arcs.save': '保存',
  'lib.arcs.cancel': '取消',
  ...
  'lib.generate.prompt': '生成提示（可选）',
  'lib.generate.submit': '开始生成',
  'lib.generate.cancel': '取消',
  'lib.generate.loading': '正在生成大纲…',
  ...
  'lib.tlLegend.narrative': '轴=章 · 事件按章推进排列；行内小字=世界内时间', 'lib.tlLegend.world': '轴=世界内时间（升序，未知末尾）· 不再按章分组；行尾=来源章',
  ...
  'lib.tlGroupNone': '未分章', 'lib.tlChapterUnknown': '未知章节', 'lib.tlAxis': '时间轴', 'lib.tlAxisMain': '主轴', 'lib.tlAxisSub': '标记', 'lib.tlTimeUnknown': '未知', 'lib.tlChCount': '{n} 个事件', 'lib.tlFilterChapter': '章：{label}', 'lib.tlFilterType': '类型：{label}', 'lib.tlFilterChapterTitle': '按章筛选', 'lib.tlFilterTypeTitle': '按事件类型筛选', 'lib.tlFilterAll': '全部', 'lib.tlFilterAllChapters': '全部章节', 'lib.tlFlag.normal': '正叙', 'lib.tlFlag.flashback': '倒叙', 'lib.tlFlag.flashforward': '插叙',
  ...
  'write.context.injectSelect': '＋ 选择注入', 'write.context.pickerSearch': '搜索已有设定…',
  'write.context.pickerAppend': '追加注入',
  'write.context.clearAll': '清除', 'write.context.preselectApplied': '已按大纲预选', 'write.context.preselectFallback': '预选未生效，已全选', 'write.context.preselectPending': 'Agent 预选中…', 'write.context.selectAll': '全选',
  ...
  // #653：写作页草稿审批（T1 草稿审批：列表/确认/驳回/编辑/清理孤儿）
  'write.drafts.title': '草稿审批',
  'write.drafts.prune': '清理孤儿',
  'write.drafts.empty': '暂无待审批草稿',
  'write.drafts.loading': '草稿加载中…',
  'write.drafts.error': '草稿加载失败',
  'write.drafts.confirm': '确认',
  'write.drafts.reject': '拒绝',
  'write.drafts.edit': '编辑',
  'write.drafts.save': '保存',
  // F34 章节审计（Issue #208）
  'audit.accept': '接受',
  'audit.reject': '拒绝',
  'audit.close': '关闭',
  ...
  'audit.related': '相关',
  // T2 风格检测（Issue #655）
  'write.style.title': '风格分析报告',
  'write.style.loading': '分析中',
  'write.style.error': '分析失败',
  'write.style.close': '关闭',
  'write.style.verdict.human': '倾向人类',
  'write.style.verdict.uncertain': '特征不明显',
  'write.style.verdict.ai': '倾向 AI',
  'write.style.fingerprint': '风格指纹',
  'write.style.aiTrace': 'AI 痕迹',
  'write.style.lexical': '词汇统计',
  'write.style.fpSentence': '句子均值',
  'write.style.fpParagraph': '段落均值',
  'write.style.fpDialogue': '对话占比',
  'write.style.fpVocab': '词汇丰富度',
  'write.style.topWords': '高频词',
  'write.style.aiScore': 'AI 得分',
  'write.style.verdictLabel': '判定',
  'write.style.evidence': '证据',
  'write.style.lexUnique': '独特词',
  'write.style.lexTotal': '总词数',
  'write.style.lexStopword': '停用词占比',
  // T3 章节摘要（Issue #656）
  'write.summary.title': '章节摘要',
  'write.summary.refresh': '刷新摘要',
  ...
  // #658：记忆统计概览
  'memory.stats.title': '统计概览',
  'memory.stats.agentic': 'Agent 行为',
  'memory.stats.total': '记忆总量',
  'memory.stats.projectPrefs': '项目偏好',
  'memory.stats.userPrefs': '用户偏好',
  'memory.stats.summaries': '语义总结',
  'memory.stats.chapters': '章节',
  'memory.stats.directConfirms': '直接确认',
  'memory.stats.modifyRate': '修改率',
  'memory.stats.regenerateRate': '重写率',
  'memory.stats.avgDiffChars': '平均改动字数',
  'memory.stats.unavailable': '概览暂不可用',
  ...
  // F60 #934 首启模型配置引导
  'setup.title': '完成模型配置',
  'setup.sub': '开始写作前，请先配置 Provider 与 chat 模型（三步，约 1 分钟）。',
  'setup.step1': '选择 Provider 并保存 API Key',
  'setup.step2': '配置 chat 模型（必填）',
  'setup.step3': '配置 embedding 模型（可跳过）',
  'setup.providerHint': '选择内建 Provider 或自定义端点，并填入 API Key。',
  'setup.addProvider': '添加 Provider',
  'setup.keySaved': 'API Key 已保存',
  'setup.keyMissing': '未配置 API Key',
  'setup.next': '下一步',
  'setup.back': '上一步',
  'setup.chatHint': '选择用于写作的 chat 模型，并测试连接通过后才能继续。',
  'setup.chatPlaceholder': '选择 chat 模型',
  'setup.testConn': '测试连接',
  'setup.testing': '测试中…',
  'setup.testUnknown': '未知错误',
  'setup.embeddingHint': 'embedding 模型用于语义检索与 RAG；可跳过，跳过后续可在设置中补配（期间语义检索入口置灰）。',
  'setup.embeddingProvider': '选择 Provider',
  'setup.embeddingModel': 'embedding 模型名',
  'setup.addEmbedding': '添加 embedding 模型',
  'setup.skipEmbedding': '跳过',
  'setup.finish': '完成',
  'setup.semanticDisabled': '语义检索需要 embedding 模型，可在设置→模型管理中配置',
  'setup.goConfigure': '前往配置',
} as const;
