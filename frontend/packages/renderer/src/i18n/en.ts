...
export const en: Record<string, string> = {
  ...
  'lib.create.category': 'Category', 'lib.create.categoryRequired': 'Category is required for non-root entries',
  ...
  'lib.tlLegend.narrative': 'Axis = chapter · events in chapter order; inline text = world time', 'lib.tlLegend.world': 'Axis = world time (ascending, unknown last) · no chapter groups; trailing chip = source chapter',
  ...
  'reasoning.level.xhigh': 'Extra high',
  'reasoning.level.default': 'Model default',
  // F60 #934 first-run model setup guide
  'setup.title': 'Finish model setup',
  'setup.sub': 'Before writing, configure a Provider and a chat model (3 steps, ~1 minute).',
  'setup.step1': 'Choose a Provider and save the API Key',
  'setup.step2': 'Configure the chat model (required)',
  'setup.step3': 'Configure the embedding model (optional)',
  'setup.providerHint': 'Pick a built-in Provider or a custom endpoint, then enter the API Key.',
  'setup.addProvider': 'Add Provider',
  'setup.keySaved': 'API Key saved',
  'setup.keyMissing': 'API Key not set',
  'setup.next': 'Next',
  'setup.back': 'Back',
  'setup.chatHint': 'Pick the chat model used for writing; the connection test must pass to continue.',
  'setup.chatPlaceholder': 'Select a chat model',
  'setup.testConn': 'Test connection',
  'setup.testing': 'Testing…',
  'setup.testUnknown': 'Unknown error',
  'setup.embeddingHint': 'The embedding model powers semantic search and RAG. You may skip it; you can add it later in Settings (semantic search stays disabled meanwhile).',
  'setup.embeddingProvider': 'Select Provider',
  'setup.embeddingModel': 'Embedding model id',
  'setup.addEmbedding': 'Add embedding model',
  'setup.skipEmbedding': 'Skip',
  'setup.finish': 'Finish',
  'setup.semanticDisabled': 'Semantic search needs an embedding model; configure it in Settings → Models',
  'setup.goConfigure': 'Go to settings',
};
