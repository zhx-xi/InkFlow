...
export default defineConfig({
  ...
  test: {
    environment: 'node',
    include: ['src/**/*.test.ts', '../../../tests/e2e/e2e-llm.config.test.ts', '../../../tests/e2e/e2e-isolation.test.ts', '../../../tests/e2e/e2e-seed.test.ts', '../../../tests/e2e/e2e-app-ready.test.ts', '../../../tests/e2e/e2e-settings-rag-gate.test.ts', '../../../tests/e2e/e2e-rag-fake-gate.test.ts'],
