...
导出 / 全文搜索 / 世界观三连 / CLI 恒经 HTTP（0.6.0）· skills 包 + MCP Server（1.0.0）· 云存档与异地写作（2.0.0）——明细见 [`FEATURES.md`](FEATURES.md)。
...
| [`CHANGELOG.md`](CHANGELOG.md) | 版本变更日志（0.1.0 → 0.5.0） | 所有人 |
...
| 0.6.0 | 导出 + 全文搜索 + 世界观三连 + CLI 恒 HTTP + 前端完善 | 🔜 |
