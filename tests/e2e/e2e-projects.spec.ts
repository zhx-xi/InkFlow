 ...
 * 承载项目页域用例（原第 1、2 用例）。
 *
 * 元素契约来源：renderer 源码 testid（AppNav / projects.tsx / NewProjectDialog）与 i18n/zh.ts 文案。
 */
