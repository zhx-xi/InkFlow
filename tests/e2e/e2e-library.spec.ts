 ...
 * 承载设定库域用例（原第 7 用例：写作 → 项目 → 设定库 → 设置侧边栏闭环，含设定库断言）。
 *
 * 元素契约来源：renderer 源码 testid（AppNav / library.tsx）与 i18n/zh.ts 文案。
 */
