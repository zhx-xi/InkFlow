 ...
 * 承载写作页域用例（原第 3、4 用例）。
 *
 * 元素契约来源：renderer 源码 testid（writing.tsx / ProjectTree / EditorToolbar / ChapterEditor）与
 * i18n/zh.ts 文案。
 */
