...
| LLM Provider | langchain-core + langchain-community + langchain-litellm + litellm | ChatLiteLLM / LiteLLMEmbeddings（litellm 统一出口，api_base 兼容多 Provider，ADR-051 取代 ADR-005v2） |
