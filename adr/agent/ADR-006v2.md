...
>
> **弃用溯源**: 本 ADR 取代 ADR-006（管道链模式，2026-07-30）——改为 LangGraph StateGraph；2026-08-12 ADR-035 再修订为 deepagents 0.7.5 harness。原 ADR-006 全文存档于 git 历史。
> **日期**: 2026-07-31
> **风险等级**: 🟡 中
> **来源**: design/architecture-analysis-2026-07-30.md §三 ADR-006v2
