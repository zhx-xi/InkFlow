...
| 0.9.0 | 多 Agent 一期 + MCP + RAG 切片 + DAG 编排 | F39/40/41 多 Agent（能力白名单 + skill 上传绑定 + Agent 编辑）· F20 MCP Server（15 聚合工具薄客户端经 HTTP）· RAG 切片（段落/对话/LLM 三档 + 指纹联动）· F46 DAG 编排（三类型 + 确定性 gate）· write_continue F6 前文摘要 · HITL GUI · 写作页 AI 聊天框/执行详情页 · e2e gaps G1-G4 · GUI 修复（内核门控/地图 resize/世界观导航）· 测试治理（假绿治本 + LLM 默认切 deepseek） | ✅ 已交付（2026-08-16 里程碑 17/17 issues 全关，PR #398/#393/#396/#400/#403/#408/#407/#401/#413/#412/#411/#417/#418/#414/#404/#406/#416） |
...
*本文件由功能盘点建立于 2026-08-02（0.2.0 交付后），与 AGENTS.md / ADR-019 口径一致（v8 修订 2026-08-16：0.9.0 多 Agent 一期 + MCP 提前 + RAG 切片 + DAG 编排交付）。*
